...
# Author: Hunter Gould
# Date: 11/21/23
# Description: This script performs portfolio analysis using Monte Carlo simulations
#              and Modern Portfolio Theory. It starts with data collection from yfinance,
#              retrieving historical stock prices for user-chosen tickers and a
#              benchmark index. The script executes Monte Carlo simulations for asset
#              allocation, calculating annualized return, volatility, and Sharpe ratio
#              for various portfolio weights. It compares optimized, current, and median
#              volatility portfolios against the market benchmark. Additionally, the script
#              includes visualization features, generating probability distribution plots
#              for different portfolio configurations. This tool is designed to identify
#              portfolios with a balanced risk-reward profile and provides insights into
#              potential performance under varying market conditions.
#
# Note: Past performance is not indicative of future results. This tool helps assess
